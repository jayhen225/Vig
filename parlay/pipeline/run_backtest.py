...
print("(offensive EPA model barely beat naive). Real signal lives")
print("in the player-level usage models, tested via prop calibration")
print("once prop odds data is available.")
